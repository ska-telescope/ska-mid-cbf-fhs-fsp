...
html_context = {
    ...
    "gitlab_repo": "ska-mid-cbf-fhs-fsp",  # Repo name
...
htmlhelp_basename = 'SKA_MidCBF_FHS_FSP'
...
latex_documents = [
    (master_doc, 'SKA_MidCbf_FHS_FSP.tex', 'SKA Mid.CBF FHS FSP Documentation',
     '{{author}}', 'manual'),
]
...
man_pages = [
    (master_doc, 'SKA_MidCbf_FHS_FSP', 'SKA Mid.CBF FHS FSP Documentation',
     ['{{author}}'], 1)
]
...
texinfo_documents = [
    (master_doc, 'SKA_MidCbf_FHS_FSP', 'SKA Mid.CBF FHS FSP Documentation',
     '{{author}}', 'SKA_MidCbf_FHS_FSP', 'FHS FSP',
     'Miscellaneous'),
]
